 ...
 * @method static void ageopenBoostData()
 ...
 * @method static void openBoost(string $key, mixed $value = true)
 * @method static void now(string $key, mixed $value)
 * @method static void reopenBoost()
 * @method static void keep(array|mixed $keys = null)
 * @method static void openBoostInput(array $value)
